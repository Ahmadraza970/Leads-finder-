...
import { downloadBookingsJson, formatDate, formatINR } from "@/lib/booking";
            ...
            <div className="rounded-2xl bg-cream p-5">
              ...
              <dl className="mt-4 grid gap-2 text-sm sm:grid-cols-2">
                ...
                <div className="flex justify-between gap-3 rounded-xl bg-white p-3 sm:col-span-2">
                  ...
                  <dd className="font-semibold text-dark">{formatINR(booking.price.total)}</dd>
                </div>
              </dl>
