      ...
      <article className="group flex h-full flex-col overflow-hidden rounded-3xl bg-white shadow-soft transition-all duration-500 hover:-translate-y-2 hover:shadow-lift">
        <div className="relative aspect-[4/3] overflow-hidden">
          <HotelImage
            ...
            alt={`${room.name} at The Grand Orion Hotel`}
            width={900}
            height={675}
    ...
    <section id="rooms" className="scroll-mt-24 bg-cream py-20 md:py-28">
      <div className="mx-auto max-w-7xl px-5 md:px-8">
        <SectionHeading
          ...
          subtitle="Every room is designed around rest — plush bedding, soft neutral palettes, climate control and thoughtful amenities, all at honest Lucknow prices."
        />
