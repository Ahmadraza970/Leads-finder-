    ...
    <section id="contact" className="scroll-mt-24 bg-beige py-20 md:py-28">
      <div className="mx-auto max-w-7xl px-5 md:px-8">
        <SectionHeading
          ...
          title="Find Us on Faizabad Road"
          subtitle="Walk out and Lucknow unfolds — or reach out first; we're always happy to help plan your stay."
        />
        ...
        <div className="grid gap-6 lg:grid-cols-5">
          ...
          <Reveal delay={0.12} className="lg:col-span-3">
            <div className="h-full min-h-[22rem] overflow-hidden rounded-3xl shadow-soft lg:min-h-[34rem]">
              <iframe
                title="The Grand Orion Hotel on Google Maps"
                src={HOTEL.mapEmbed}
                loading="lazy"
                allowFullScreen
