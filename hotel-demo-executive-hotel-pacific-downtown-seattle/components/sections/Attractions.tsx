    ...
    <section id="attractions" className="scroll-mt-24 bg-beige py-20 md:py-28">
      <div className="mx-auto max-w-7xl px-5 md:px-8">
        <SectionHeading
          ...
          title="Lucknow, All Within Reach"
          subtitle="From gardens and heritage monuments to shopping and the airport — The Grand Orion Hotel puts the city's highlights a short drive away."
        />
