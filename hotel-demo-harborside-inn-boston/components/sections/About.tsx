...
const CHECKMARKS = [
  ...
  "Opposite the New High Court, off Boston waterfront",
        ...
        <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
          ...
          <Reveal direction="right" className="relative">
            <div className="relative">
              <div className="overflow-hidden rounded-3xl shadow-lift">
                <HotelImage
                  imageId={ABOUT_IMAGE}
                  alt="Guest room at Harborside Inn"
                  width={1000}
                  height={1240}
          ...
          <div>
            <SectionHeading
              ...
              title={`A Heritage of Welcome, in the ${"Heart"} of Boston waterfront`}
              className="mb-8"
            />
            <Reveal delay={0.1}>
              <p className="leading-relaxed text-soft text-pretty">
                On the city&rsquo;s busiest artery, <strong className="font-semibold text-dark">Boston waterfront</strong>,
                just opposite the New High Court, Harborside Inn is where
                Boston&rsquo;s famed hospitality meets everyday comfort. Our
