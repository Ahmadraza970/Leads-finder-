...
**Agreement Reference:** HBD-IN-LEAD-001-202609  
...
2. **Client / Property Owner:**  
   **Cottage Cold Corner**  
   Attn: Hotel Owner / General Manager  
   Location: Manali  
   Email:  | Phone:   
...
- Modern, luxury design optimized for Cottage Cold Corner
...
- **Total Project Fee:** **INR 8,000.00**
- **Milestone 1 (Deposit):** **INR 4,000.00** (50%) due upon signing to initiate design & development.
- **Milestone 2 (Final Balance):** **INR 4,000.00** (50%) due upon final approval and domain launch.
...
**CLIENT / HOTEL OWNER:**  
Signature: ___________________________  
Name: Hotel Owner / General Manager  
Title: Authorized Signatory for Cottage Cold Corner  
